...
\newcommand*{\bbmsy}[1]{$B/B_\mathrm{MSY}$}
\newcommand*{\bbmsyhat}[1]{$\widehat{B/B_\mathrm{MSY}}$}
...
\title{Improving estimates of population status and trajectory with ensemble models}
\author{}
\date{}
...
\bibliography{jshort,fisheries-ensembles}
