...
Let's read in the data, source some functions, and manipulate the data so we can create some ROC curves at relevant thresholds for the OHI.
...
Get ROC and AUC for models applied to simulation data with b/bmsy as the response. We'll use 0.8 B/Bmsy as the threshold to start with. 
